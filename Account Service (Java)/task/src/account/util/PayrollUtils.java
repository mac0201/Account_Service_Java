...
public class PayrollUtils {
    ...
    public static final SimpleDateFormat periodOutputFormatter = new SimpleDateFormat("MMMM-yyyy");
    // define period regex
    public static final String PAYROLL_REGEX = "^((0[1-9])|(1[0-2]))-(\\d{4})$";
    public static final String PAYROLL_REGEX_ERROR = "Period must match following pattern: MM-YYYY";
}
